...
Процедура ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов) Экспорт
	...
	// МРГ +
	// Добавление в список объектов, подключенных к механизму внешних печатных форм, объектов.
	МРГ_УправлениеПечатьюСервер.ПриОпределенииОбъектовСКомандамиПечати(СписокОбъектов);
	// МРГ -
